...
export const { setEscorts, setEscortProfile, updateEscortProfile, setStatus } = escortsSlice.actions;

export const selectEscorts = (state: RootState) => state.escorts.escorts;
export const selectEscortProfile = (state: RootState) => state.escorts.escortProfile;
